        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="border border-blue-800 rounded-lg p-1 m-1">
                <div class="hidden sm:block">
                    Modifications de quelques informations d'un auteur déjà existant.
                </div>
                <livewire:author-search intro="Phase de sélection de l'auteur" label="Recherche de l'auteur" />
            </div>
            @if ($errors->any())
                <div class="p-2">
