                ...
                <div class="p-6">
                    ...
                    <div class="p-2">
                        <ul class="list-disc pl-4">
                            <li><x-bdfi-adm-link lien='outils/anniversaires-fb-jour'>Anniversaires du jour</x-bdfi-adm-link></li>
                            <li><x-bdfi-adm-link lien='outils/anniversaires-fb-semaine'>Anniversaires  de la semaine</x-bdfi-adm-link></li>
                            <li><x-bdfi-adm-link lien='outils/anniversaires-fb-mois'>Anniversaires du mois</x-bdfi-adm-link></li>
                        </ul>
                    </div>
                    <div class="p-2 text-2xl border-b border-yellow-800">
                        Autre outils
