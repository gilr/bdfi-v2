<x-app-layout>
    ...
    <div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="border border-blue-800 rounded-lg p-2 hidden sm:block my-2">
                Ajout d'une publication à paraître et non déjà recensée.
                <livewire:publication-search intro="Si besoin, (re-)vérifier la non existence" label="Recherche ouvrage" />
            </div>
            @if ($errors->any())
                <div class="p-2">
    ...
    <div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            {{ html()->form('POST', '/admin/formulaires/programme-parution')->open() }}
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                @foreach (App\Enums\PublicationStatus::cases() as $type)
                    @if ($type === App\Enums\PublicationStatus::ANNONCE)
                ...
                {{ html()->hidden($name = "publication_status", $value = App\Enums\PublicationStatus::ANNONCE->value) }}
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                Format 'AAAA-MM-00' (exemple : 2024-06-00, pour juin 2024). 'AAAA-00-00' si lemois n'est pas connu, ou éventuellement 'AAAA-MM-JJ' si le jour est donné par l'éditeur.
            </div>
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
