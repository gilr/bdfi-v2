                            ...
                            @foreach ($variant->publications->sortBy('approximate_parution') as $publication)
                                ...
                                <div class='ml-2 md:ml-8'>
                                    ...
                                    @if($publication->publisher)
                                        - <x-front.lien-editeur link='/editeurs/{{ $publication->publisher->slug }}'>{{ $publication->publisher_name != "" ? $publication->publisher_name : $publication->publisher->name }}</x-front.lien-editeur>
                                    @endif
